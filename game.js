(function () {
  ...
  var draw_sloth = function () {
    ...
    if (game.dead > 0) {
      ...
      if (game.facing === 'u') {
        // 67 391
        context.drawImage(sprites, 45, 369, game.width, game.height, game.posX, game.posY, game.width, game.height);
      } else if (game.facing === 'd') {
        context.drawImage(sprites, 113, 369, game.width, game.height, game.posX, game.posY, game.width, game.height);
      } else if (game.facing === 'l') {
        context.drawImage(sprites, 113, 339, game.width, game.height, game.posX, game.posY, game.width, game.height);
      } else if (game.facing === 'r') {
        context.drawImage(sprites, 45, 336, game.width, game.height, game.posX, game.posY, game.width, game.height);
      }
    }
  };
  ...
  var up = function () {
    if (bounds_check(game.posX, game.posY - 30)) {
      game.posY -= game.speed;
      game.current++;
    }
    if (game.current > game.highest) {
      game.score += game.scorePoint;
      game.highest++;
    }
    game.facing = 'u';
  };
  ...
  var left = function () {
    if (bounds_check(game.posX - 30, game.posY)) game.posX -= game.speed;
    game.facing = 'l';
  };
